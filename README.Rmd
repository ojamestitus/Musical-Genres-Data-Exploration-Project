...
From looking at the means we can see a few characteristics that appear to make each genre stand apart. A summary of these differences can be useful in coming to a hypthesis of what traits make each genre unique. Also by looking at the genres popularity we may find a few clues as to which traits could give us an indication of the popularity of the track.
