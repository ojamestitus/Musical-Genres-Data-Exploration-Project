...
> We will want to make some comments about each of these boxplots before moving on to some nice summary statistics.
  Also we will want to make sure all of these are either vertical or horizontal.
...
> It would be nice to run hypothesis tests at this point to determine if there is a difference in the means of the items that we looked at and summarized above. I am not familar with using R for hypothesis testing, but I am willing to figure it out if nobody else knows how to do it.
